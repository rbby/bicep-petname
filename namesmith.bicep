...
// Generates a four-word pet name (adverb + adverb + adjective + name)
@export()
...
// Output: Generated pet name using parameters
output petName string = wordCount == 1 ? getName(seed) : wordCount == 2 ? generateTwoWords(separator, seed) : wordCount == 3 ? generateThreeWords(separator, seed) : generateFourWords(separator, seed)
