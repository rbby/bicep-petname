/*
  bicep namesmith: Generate human-readable, random names for Azure resources (e.g. hostnames, containers, blobs)

  Name generation is inspired by https://github.com/dustinkirkland Petname library
...
@description('Number of words in the generated name (1-4)')
@minValue(1)
@maxValue(4)
