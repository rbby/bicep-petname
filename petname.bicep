...
@export()
func getRandomIndex(arrayLength int, seedValue int) int => seedValue % arrayLength
...
output petName string = wordCount == 1 ? getName(seed) : wordCount == 2 ? generateTwoWords(separator, seed) : generateThreeWords(separator, seed)
